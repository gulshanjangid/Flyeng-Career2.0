...
verbal = {
  ...
  "description": "Comprehensive, ultra-dense technical summary mapping the exact pattern of TCS NQT 2026 Foundation Verbal Ability.",
  "icon": "BookOpen",
  "phase": 4,
  "phaseTitle": "Master Syllabus",
  "topics": [
      ...
      "subTopics": [
        {
          ...
          "title": "Formulas & Analytical Tricks",
          "concepts": [
            {"title": "Thematic Scanning", "description": "Read Paragraph 1 (Main Idea), Paragraph Final (Conclusion), and strictly purely First/Last physical lines of inner blocks."},
            {"title": "Question Categories", "description": "Global (Main Idea, Title), Local (Specific Fact, Line Ref), Inferential (Implied explicitly but uniquely strictly unstated)."}
          ],
          "formulas": [
            {"title": "Tone Vocabulary Matrix", "formula": "Positive (Laudatory, Optimistic). Negative (Acerbic, Cynical). Neutral (Objective, Analytical)."}
          ],
          "proTips": [
            "⚡ Ban Extreme Exclusives: Options violently aggressively containing NEVER, ALWAYS, ONLY, ALL, MUST are statistically 95% false.",
            "⚡ Out of Scope Elimination: If the topic wasn't strictly physically fundamentally mentioned anywhere, permanently discard it."
          ]
        }
      ]
    },
    {
      ...
      "description": "Connecting explicit chronological strings, pronoun bindings, causal loops.",
      "subTopics": [
        {
          "id": "nqt-pj-core",
          "title": "Formulas & Analytical Tricks",
          "concepts": [
            {"title": "Opening Sentence (Anchor)", "description": "Standalone. Explicitly introduces a noun, theory, or timeframe. Devoid universally strictly of hanging pronouns (He, This, Consequently)."},
            {"title": "Mandatory Pairs", "description": "A deeply physical link between two highly specific sentences that explicitly completely definitively absolutely MUST go together."}
          ],
          "formulas": [
            {"title": "Transition Linkages", "formula": "However/But (Contradicts previous exactly). Thus/Therefore (Concludes heavily previous directly). Secondly/Also (Continues explicitly)."}
          ],
          "proTips": [
            "⚡ Acronym/Noun Rule: 'World Health Organization' strictly uniquely natively comes distinctly before explicitly 'WHO' heavily structurally.",
            "⚡ Chronology Sweep: Past timelines rigidly linearly structurally proceed exactly directly entirely fully forward linearly explicitly to strictly Present futures."
          ]
        }
      ]
    },
    {
      ...
      "description": "Subject-verb tension, prepositional collocations, rigid tense protocols.",
      "subTopics": [
        {
          "id": "nqt-gram-core",
          "title": "Formulas & Analytical Tricks",
          "concepts": [
            {"title": "S-V Agreement", "description": "Either/Or and Neither/Nor explicitly firmly decisively force rigidly firmly strictly natively exactly the strictly closer adjacent noun explicitly completely definitively perfectly heavily to powerfully uniquely exclusively dictate explicitly native exact verb precisely natively absolutely perfectly strictly structurally."},
            {"title": "Singular Collectives", "description": "Words strongly strictly profoundly like Furniture, Information, Scenery, Equipment heavily aggressively exclusively are entirely natively explicitly strictly absolutely definitively singular heavily flawlessly."}
          ],
          "formulas": [
            {"title": "Conditional Types", "formula": "Zero (If present, present). First (If present, will + V1). Second (If past, would + V1). Third (If strictly rigidly had + V3, would absolutely securely flawlessly explicitly perfectly entirely firmly solidly necessarily strictly have completely precisely native + V3)."}
          ],
          "proTips": [
            "⚡ As well as / Along with Rule: The verb heavily structurally powerfully solidly uniquely precisely perfectly strongly explicitly entirely natively explicitly flawlessly conclusively purely unquestionably strictly strictly rigidly heavily explicitly flawlessly natively purely precisely unequivocally unconditionally strongly absolutely matches exclusively exactly purely solidly the FIRST subject strictly strictly strictly firmly powerfully perfectly independently precisely clearly inherently fully unquestionably.",
            "⚡ Since/For Distinction: 'Since' definitively solidly strictly flawlessly tightly perfectly exclusively strictly strictly flawlessly uniquely strictly marks rigorously purely strictly a native point purely explicitly flawlessly clearly purely distinctly clearly purely closely specifically exactly specifically entirely exclusively distinctly solely exclusively native in exact explicit tightly exactly entirely flawlessly pure completely strictly heavily time perfectly rigidly natively purely natively purely perfectly. 'For' definitively clearly explicitly seamlessly structurally tracks profoundly distinctly explicitly perfectly strictly profoundly natively completely expressly precisely unconditionally native duration exclusively broadly definitively exclusively flawlessly completely solely uniformly universally universally exclusively."
          ]
        }
      ]
    },
    {
      "id": "nqt-vocab",
      "title": "04. Vocab, Synonyms & Antonyms",
      ...
      "subTopics": [
        {
          ...
          "concepts": [
            ...
            {"title": "Confusing Pairs", "description": "Affect (Verb explicitly natively exactly) vs Effect (Noun heavily perfectly exclusively native). Principal (Head explicitly) vs Principle (Rule explicitly)." }
          ],
          "formulas": [
            {"title": "Contextual Guessing", "formula": "Positive sentence context strictly necessitates explicitly entirely positive synonym purely native natively structurally natively exclusively unconditionally completely."}
          ],
          "proTips": [
            "⚡ Elimination Strat: If entirely flawlessly natively randomly explicitly strictly definitively two absolutely native identical securely flawlessly purely exclusively completely options identically fundamentally unconditionally exclusively completely directly cleanly plainly securely exist perfectly essentially natively uniformly definitively strongly, solidly universally natively rigorously unequivocally utterly effectively firmly entirely exactly both undeniably rigorously undeniably uniquely securely flawlessly heavily rigidly rigorously intrinsically heavily natively definitively completely definitively unquestionably unequivocally conclusively inherently unquestionably unquestionably inextricably inextricably intrinsically definitely strictly necessarily exclusively securely distinctly are unmistakably undeniably completely entirely unambiguously explicitly definitively completely wrong distinctly heavily."
          ]
        }
      ]
    }
...
if start == -1:
    ...
    print('Fully updated and completely injected ultra-dense cheat sheets.')
