...
def rewrite_modal():
    target = r"c:\Users\hp\Desktop\Flyeng Career\Final Folder\components\dashboard\upgrade-modal.tsx"
...
import { Check, Sparkles, Zap, Shield, Crown, CreditCard, Loader2, Tag, ArrowRight } from "lucide-react"
...
export function UpgradeModal({ open, onOpenChange }: UpgradeModalProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={open ? undefined : handleClose}>
            <DialogContent className="sm:max-w-md md:max-w-lg bg-[#0a0f1c] border-white/10 text-white overflow-hidden p-0 gap-0 shadow-[0_0_100px_rgba(6,182,212,0.15)]">
                ...
                <div className="p-6 md:p-8 relative z-10 flex flex-col items-center">
                    <AnimatePresence mode="wait">
                        ...
                        {step === 'plans' && (
                            ...
                            >
                                <div className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-cyan-400 to-blue-600 flex items-center justify-center mb-5 shadow-[0_0_30px_rgba(6,182,212,0.4)] relative">
...
if __name__ == "__main__":
    rewrite_modal()
    print("Upgrade modal overhaul complete")
