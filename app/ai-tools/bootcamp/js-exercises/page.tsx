        ...
        <div className={cn("min-h-screen bg-[#0d0d12] text-slate-200 flex flex-col font-sans", inter.className)}>
            ...
            <header className="sticky top-0 z-50 bg-[#12121a]/80 backdrop-blur-md border-b border-white/10 px-6 py-4 flex items-center justify-between shadow-sm h-[73px]">
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-teal-500/20 flex items-center justify-center border border-teal-500/30 shadow-[0_0_15px_rgba(45,212,191,0.2)]">
                        <Code2 className="w-5 h-5 text-teal-400" />
                    </div>
                    <div>
                        <h1 className={cn("font-bold text-slate-100 text-lg", quicksand.className)}>JS Bootcamp</h1>
                    ...
                    <div className="max-w-3xl mx-auto relative z-10 pb-20">
                        ...
                        <div className="flex bg-[#1a1a24] p-1.5 rounded-2xl border border-white/5 mb-8 w-fit">
                            ...
                            <button
                                ...
                                className={cn("px-6 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 transition-all",
                                    activeTab === 'exercises' ? "bg-teal-500/20 text-teal-300 shadow-sm" : "text-slate-400 hover:text-slate-200"
                                )}
                            >
                                    ...
                                    (day.concepts || []).map((concept, ci) => {
                                        ...
                                        return (
                                            <div key={ci} className="bg-[#161621] border border-white/10 rounded-2xl p-6 md:p-8 overflow-hidden relative">
                                                {read && <div className="absolute top-0 right-0 w-32 h-32 bg-teal-500/10 blur-3xl rounded-full pointer-events-none" />}
                                                    ...
                                                    <div className="px-5 pb-5 pt-2 border-t border-white/5 border-dashed">
                                                        ...
                                                        {ex.kind === 'mc' ? (
                                                            <div className="space-y-2 mb-5">
                                                                {ex.opts?.map((opt, oi) => {
                                                                    ...
                                                                    if (picked !== undefined) {
                                                                        if (isCorrect) btnClass = "bg-teal-500/10 border-teal-500/50 text-teal-300 cursor-default"
                                                            ...
                                                            <div className="mb-5 space-y-3">
                                                                ...
                                                                <textarea 
                                                                    ...
                                                                    className={cn(
                                                                        ...
                                                                        mono.className,
                                                                        feedback[k]?.ok ? "border-teal-500/50 focus:border-teal-500 focus:ring-teal-500/20 bg-teal-500/5" : "",
                                                        ...
                                                        {feedback[k] && (
                                                            <div className={cn(
                                                                ...
                                                                feedback[k].ok ? "bg-teal-500/10 text-teal-400 border border-teal-500/20" : "bg-rose-500/10 text-rose-400 border border-rose-500/20"
                                                            )}>
                                                        ...
                                                        <div className="flex flex-wrap gap-3 pt-3 border-t border-white/5 border-dashed">
                                                            ...
                                                            {solved && (
                                                                <button 
                                                                    ...
                                                                    className="text-xs font-bold uppercase tracking-wider text-slate-400 hover:text-teal-400 transition-colors flex items-center gap-1.5"
                                                                >
                                                            ...
                                                            {solOpen[k] && solved && (
                                                                ...
                                                                >
                                                                    <div className="rounded-xl bg-[#0a1511] border border-teal-900/50 overflow-hidden">
                                                                        <div className="px-4 py-2 bg-teal-950/40 border-b border-teal-900/50 text-xs font-bold uppercase tracking-wider text-teal-500">
                        ...
                        <AnimatePresence>
                            {isDayCompleted && (
                                <motion.div
                                    ...
                                    className="mt-8 p-8 rounded-[2rem] bg-gradient-to-br from-teal-500/20 to-indigo-500/20 border border-teal-500/30 text-center relative overflow-hidden"
                                >
                                    <Sparkles className="absolute top-4 right-4 text-teal-400 w-8 h-8 opacity-50" />
                                    ...
                                    {currentDay < DAYS.length - 1 ? (
                                        <button 
                                            ...
                                            className="px-8 py-3 rounded-xl bg-teal-500 hover:bg-teal-400 text-teal-950 font-bold transition-all shadow-[0_0_20px_rgba(45,212,191,0.4)]"
                                        >
