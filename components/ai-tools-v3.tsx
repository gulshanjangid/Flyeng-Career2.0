...
const HolographicCard = dynamic(() => import("@/components/holographic-card").then(mod => mod.HolographicCard), { ssr: true })
...
import {
    ...
    ScanLine, Layout, Code2, Network, Check, Loader2, Radar, Brain, Flame, Sparkles, GraduationCap
} from 'lucide-react'
...
const tools = [
    ...
    },
    {
        ...
        description: "Master quantitative, logical, and verbal aptitude with AI mock tests.",
        href: "/aptitude-prep",
        plan: "Free",
        category: "Career Prep",
        new: true,
    ...
    },
    {
        ...
        description: "Hunt Down The Future. Track Rising Skills & Roles.",
        href: "/ai-tools/trend-hunter",
        plan: "Elite",
        ...
        accent: "text-cyan-400",
        bgIcon: "bg-cyan-500/10",
        spotlight: "rgba(34, 211, 238, 0.6)",
        border: "rgba(34, 211, 238, 0.5)"
    },
    {
        title: "Code Critic AI",
        icon: <Flame className="w-8 h-8" />,
        description: "Exposes bad practices, panic commits, and why FAANG ignores your GitHub.",
        href: "/ai-tools/github-roaster",
        plan: "Free",
        category: "Career Prep",
        new: true,
        accent: "text-red-500",
        bgIcon: "bg-red-500/10",
        spotlight: "rgba(239, 68, 68, 0.6)",
        border: "rgba(239, 68, 68, 0.5)"
    },
    {
        title: "Live Code Sandbox",
        icon: <Code2 className="w-8 h-8" />,
        description: "Experience a live 15-minute interactive coding interview with real-time AI monitoring.",
        href: "/ai-tools/code-sandbox",
        plan: "Free",
        category: "Career Prep",
        new: true,
        accent: "text-orange-500",
        bgIcon: "bg-orange-500/10",
        spotlight: "rgba(249, 115, 22, 0.6)",
        border: "rgba(249, 115, 22, 0.5)"
    },
    {
        title: "VibeShift AI",
        icon: <Sparkles className="w-8 h-8" />,
        description: "Never sound generic again. Translate your boring thought into 6 totally unhinged internet personas.",
        href: "/ai-tools/vibeshift",
        plan: "Free",
        category: "Productivity",
        new: true,
        accent: "text-indigo-500",
        bgIcon: "bg-indigo-500/10",
        spotlight: "rgba(99, 102, 241, 0.6)",
        border: "rgba(99, 102, 241, 0.5)"
    },
    {
        title: "Company Insider",
        icon: <Target className="w-8 h-8" />,
        description: "Infiltrate. Decode Salaries & Culture Secrets.",
        href: "/ai-tools/company-insider",
        plan: "Elite",
        categoryId: "market-intelligence", // phantom property for diff match
        category: "Market Intelligence",
        new: true,
    ...
    {
        title: "AI Bootcamp Hub",
        icon: <GraduationCap className="w-8 h-8" />,
        description: "Master Web Dev, AI & DSA. Interactive, stress-free bootcamps with AI-mentored challenges.",
        href: "/ai-tools/bootcamp",
        plan: "Free",
        category: "Learning",
        new: true,
